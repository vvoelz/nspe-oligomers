...
for ((i=0; i<n; i++)); do
  ...
  cp ../nspe_7_2_nodistre_yesomegas.itp .
  cp ../nspe_7_2.top .
  ...
  required_files=(
    "nspe_7_2.gro"
    "nspe_7_2_nodistre_yesomegas.itp"
    "nspe_7_2.top"
  ...
  gmx grompp -f prod_remd.mdp -c nspe_7_2.gro -p nspe_7_2.top -n index.ndx -o HREMD.tpr -maxwarn 1
