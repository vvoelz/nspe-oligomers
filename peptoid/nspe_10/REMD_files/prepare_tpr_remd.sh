...
for ((i=0; i<n; i++)); do
  ...
  # Copy required files
  #cp ../nspe_10.gro .
  mv HREMD.part0001.gro nspe_10.gro  ## Uncomment for continuous simulation
  cp ../nspe_10_nodistre_yesomegas.itp .
  cp ../nspe_10.top .
  ...
  required_files=(
    "nspe_10.gro"
    "nspe_10_nodistre_yesomegas.itp"
    "nspe_10.top"
  ...
  gmx grompp -f prod_remd.mdp -c nspe_10.gro -p nspe_10.top -n index.ndx -o HREMD.tpr -maxwarn 1
